...
@Component
@Profile("local | test")
public class InMemoryAdminSalesComparisonCacheStore implements AdminSalesComparisonCacheStore {
    ...
    private static String key(Long tenantId, Long adminUserId, String type, Long salesUserId) {
        ...
        return "admin:comparison:" + tenantId + ":" + adminUserId + ":" + type + ":" + userPart;
    }

    private static String prefixForAdmin(Long tenantId, Long adminUserId) {
        return "admin:comparison:" + tenantId + ":" + adminUserId + ":";
    }
